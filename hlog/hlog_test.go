...
func TestRequestIDHandler(t *testing.T) {
	...
	h := RequestIDHandler("id", "Request-Id")(
		http.HandlerFunc(
			func(w http.ResponseWriter, r *http.Request) {
...
func TestCustomHeaderHandler(t *testing.T) {
	...
	h := CustomHeaderHandler("reqID", "X-Request-Id")(
		http.HandlerFunc(
			func(w http.ResponseWriter, r *http.Request) {
				l := FromRequest(r)
				l.Log().Msg("")
...
func TestResponseHeaderHandler(t *testing.T) {
	...
	w := httptest.NewRecorder()
	r := &http.Request{}
	h := ResponseHeaderHandler("encoding", "Content-Encoding")(
		http.HandlerFunc(
			func(w http.ResponseWriter, r *http.Request) {
