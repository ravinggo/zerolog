...
var (
	levelNameHook = HookFunc(
		func(e *Event, level Level, msg string) {
	...
	discardHook = HookFunc(
		func(e *Event, level Level, message string) {
			e.Discard()
		},
	)
	contextHook = HookFunc(
		func(e *Event, level Level, message string) {
